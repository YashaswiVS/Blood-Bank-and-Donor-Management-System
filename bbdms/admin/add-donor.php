...
$imagee=$_POST['imagee'];
$status=1;
$sql="INSERT INTO  tblblooddonars(FullName,MobileNumber,EmailId,Age,Gender,BloodGroup,Address,status,imagee) VALUES(:fullname,:mobile,:email,:age,:gender,:blodgroup,:address,:status,:imagee)";
...
<!-- <div class="col-sm-10"> -->
<!-- <input type="file"  class="form-control" name="imagee" required > -->
<!-- </div>
</div> -->
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2">
													...
													<center><button class="btn btn-primary" name="submit"  style=" font-family: 'Times New Roman', Times, serif; font-size:16px" type="submit">SUBMIT</button></center>
												</div>
											</div>
