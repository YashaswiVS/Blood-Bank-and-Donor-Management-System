				...
				<div class="row">
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
						<input type="text" class="form-control" name="bloodgroup" id="bloodgroup" required pattern="[A-Za-z+-]+" title="input Eg: B+">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<center>	<button class="btn btn-primary" style="font-family:times new roman;font-size:15px"  name="submit" type="submit">Submit</button></center>
												</div>
											</div>
